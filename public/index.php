...
$router->add('add_Expense', ['controller' => 'ExpenseController', 'action' => 'create']);
$router->add('income', ['controller' => 'IncomeController', 'action' => 'new']);
$router->add('add_Income', ['controller' => 'IncomeController', 'action' => 'create']);
$router->add('balance', ['controller' => 'BalanceController', 'action' => 'create']);
$router->add('show_balance', ['controller' => 'BalanceController', 'action' => 'create']);
